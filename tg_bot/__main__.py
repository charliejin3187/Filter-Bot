    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN,reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="😬Add Groups😬", url="t.me/{}?startgroup=true".format(bot.username))(text="❤️My Group❤️", url="t.me/{}".format(TG_GROUP))(text="🧡My Channel🧡", url="t.me/{}".format(TG_CHANNEL))]])                                
    else:
        update.effective_message.reply_text("")
